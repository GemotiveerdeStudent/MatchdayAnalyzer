...
namespace MatchdayAnalyzer.Controllers
{
    public class SeasonsController : Controller
    {
        ...
        public SeasonsController(MatchdayAnalyzerContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Seasons != null ? 
                          ...
                          Problem("Entity set 'MatchdayAnalyzerContext.Seasons'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Date")] Season season)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Date")] Season season)
        {
            if (id != season.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MatchdayAnalyzerContext.Seasons'  is null.");
            }
            var season = await _context.Seasons.FindAsync(id);
            if (season != null)
            {
